...
site.fuel.electricity.method = 'dollars';
site.fuel.electricity.amount = 80;

site.fuel.naturalGas.method = 'dollars';
site.fuel.naturalGas.amount = 40;

site.fuel.heatingOil.method = 'dollars';
site.fuel.heatingOil.amount = 10;

site.fuel.propane.method = 'energy';
site.fuel.propane.amount = 55;

site.fuel.gasoline.method = 'energy';
site.fuel.gasoline.amount = 50;

site.fuel.diesel.method = 'energy';
site.fuel.diesel.amount = 50;

console.log('\nSITE');
console.log('siteEnergyPrices',homeEnergyPrices);
console.log('site.fuel',site.fuel);
console.log('site.siteEnergyFactors',site.homeEnergyFactors());
console.log('site.totalEmissions',site.totalEmissions());