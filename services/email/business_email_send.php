        ...
        <td width="1000" style="padding: 20px 18px;"><table width="962" cellpadding="0" cellspacing="0" border="0" align="center" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 20px 18px; border-collapse:collapse">
            ...
            <td width="952" style="padding: 0 0 0 135px;"><table width="817" cellspacing="0" cellpadding="0" border="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse:collapse">
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_site.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="41" /></td>
                  <td width="387" valign="middle" style="padding: 0 0 0 63px;"><h4 style="color: #1E0770; font-weight: 900; line-height: 100%; vertical-align: baseline; font-family: "Myriad Pro", "Lucida Grande", "Lucida Sans Unicode", Arial, sans-serif; font-size: 37px; letter-spacing: 1.4px; -moz-text-size-adjust: none; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0;">'.number_format($co2e_site).' lbs CO2e</h4></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_fleet.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="49" /></td>
                ...
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_travel.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="52" /></td>
                ...
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_commute.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="46" /></td>
                ...
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_shipping.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="46" /></td>
                ...
                <tr>
                  ...
                  <td width="52"><img src="http://www.terrapass.com/email/img/ico_server.png" alt="" title="" border="0" style="display: block; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0;" height="46" /></td>
                  <td width="450" valign="middle" style="padding: 0 0 0 63px;"><h4 style="color: #91C03F; font-weight: 900; line-height: 100%; vertical-align: baseline; font-family: "Myriad Pro", "Lucida Grande", "Lucida Sans Unicode", Arial, sans-serif; font-size: 37px; letter-spacing: 1.4px; -moz-text-size-adjust: none; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0;">'.number_format($co2e_server).' lbs CO2e</h4></td>
                </tr>
                <tr>
                  <td colspan="3" height="29" style="height: 29px; line-height: 29px;"></td>
                </tr>
