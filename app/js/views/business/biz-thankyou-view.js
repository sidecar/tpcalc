  ...
  submitData: function() {
    ...
    if(isEmail(email)) {
      ...
      var data = {
        ...
        siteTotalEmissions: numeral(site.get('totalEmissions')*2204.62262).format('0.00'),
        fleetVehicles: fleetVehicleDataString,
        fleetTotalEmissions: numeral(fleet.get('totalEmissions')*2204.62262).format('0.00'),
        ...
        commuteTotalEmissions: numeral(commute.get('totalEmissions')*2204.62262).format('0.00'),
        ...
        shippingTotalEmissions: numeral(shipping.get('totalEmissions')*2204.62262).format('0.00'),
        serverNumServers: server.get('numServers'),
        serverZip: server.get('zip'),
        serverTotalEmissions: numeral(server.get('totalEmissions')*2204.62262).format('0.00'),
        trees: trees,
