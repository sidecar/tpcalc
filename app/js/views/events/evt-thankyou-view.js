  ...
  submitData: function() {
    ...
    if(isEmail(email)) {
      ...
      var data = {
        ...
        venueTotalEmissions: numeral(venue.get('totalEmissions')*2204.62262).format('0.00'),
        waterBottles: water.get('bottles'),
        waterTotalEmissions: numeral(water.get('totalEmissions')*2204.62262).format('0.00'),
        mealsNumMeals: meals.get('numMeals'),
        mealsPercentVeg: meals.get('percentVeg'),
        mealsTotalEmissions: numeral(meals.get('totalEmissions')*2204.62262).format('0.00'),
        trees: trees,
