...
client = new Client();
var factors = require('../vehicle-emissions-factors');
var utils = require('../utililtys');
...
module.exports = Backbone.Model.extend({
	...
	getTotalCH4: function(mileage) {
		...
		var factor = factors.gCH4PerMile[mappedVClassName][this.fuelType][this.year][0];
		return mileage * factor
	},
	getTotalN2O: function(mileage) {
		var mappedVClassName = this.isCarOrTruck(this.vehicleClass);
		var factor = factors.gN2OPerMile[mappedVClassName][this.fuelType][this.year][0];
		return mileage * factor
	},
	getTotalCO2: function(annualFuelGallons) {
		var factor = factors.kgCO2PerGallon[this.fuelType];
